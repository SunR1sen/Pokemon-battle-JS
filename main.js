...
class Game {
  ...
  showCards = () => {
    ...
    document.querySelector(".logs-wrapper").style.display = "block";
	};
	
	clearLog = () => {
		document.querySelector(".logs-wrapper").style.display = "none";
		document.querySelectorAll(".logItem").forEach((item) => item.remove());
	}
